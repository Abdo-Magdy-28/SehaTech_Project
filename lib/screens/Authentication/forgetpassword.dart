...
class Forgetpassword extends StatefulWidget {
  const Forgetpassword({super.key, required this.pin});
  final String pin;
  @override
  State<Forgetpassword> createState() => _ChangepasswordState();
}

class _ChangepasswordState extends State<Forgetpassword> {
