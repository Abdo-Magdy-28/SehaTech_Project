...
class Medicinescanner extends StatefulWidget {
  ...
  const Medicinescanner({super.key, required this.camera});

  @override
  State<Medicinescanner> createState() => _ScannerscreenState();
}

class _ScannerscreenState extends State<Medicinescanner> {
